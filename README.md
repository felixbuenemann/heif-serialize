# heif-serialize [![CI](https://img.shields.io/github/actions/workflow/status/felixbuenemann/heif-serialize/ci.yml?style=flat-square&label=CI)](https://github.com/felixbuenemann/heif-serialize/actions/workflows/ci.yml) [![crates.io](https://img.shields.io/crates/v/heif-serialize?style=flat-square)](https://crates.io/crates/heif-serialize) [![lib.rs](https://img.shields.io/crates/v/heif-serialize?style=flat-square&label=lib.rs&color=blue)](https://lib.rs/crates/heif-serialize) [![docs.rs](https://img.shields.io/docsrs/heif-serialize?style=flat-square)](https://docs.rs/heif-serialize) [![MSRV](https://img.shields.io/badge/MSRV-1.93-blue?style=flat-square)](https://doc.rust-lang.org/cargo/reference/manifest.html#the-rust-version-field) [![license](https://img.shields.io/crates/l/heif-serialize?style=flat-square)](#license)
